...
public class SecurityConfig {
    ...
    public SecurityFilterChain securityFilterChain(
            HttpSecurity http, JwtAuthenticationFilter jwtFilter, CorsConfigurationSource corsConfigurationSource)
            throws Exception {
                ...
                .authorizeHttpRequests(
                        auth ->
                                auth.requestMatchers(HttpMethod.OPTIONS, "/**")
                                        ...
                                        .permitAll()
                                        .requestMatchers(HttpMethod.GET, "/api/v1/reviews/summary")
                                        .permitAll()
                                        .requestMatchers(HttpMethod.GET, "/api/v1/reviews/items/**")
                                        .permitAll()
                                        .requestMatchers(
                                                HttpMethod.POST,
                                        ...
                                        .permitAll()
                                        .requestMatchers(HttpMethod.POST, "/api/v1/webhooks/razorpay")
                                        .permitAll()
